...
while True:
    ...
    while True:
        plataforma = input(Fore.BLUE + "Ingrese la plataforma (Playstation/PC/Mobile): ")
    ...
    while True:
        ...
        if formato in ["Fisico", "Digital"]:
            break
        print(Fore.RED + "Formato invalido. Escriba exactamente: Fisico o Digital.")
    ...
    while True:
        ...
        if genero == "Terror":
            ...
            cont_aventura += 1
        if genero in ["Terror", "Accion", "Aventura"]:
            break
        print(Fore.RED + "Genero invalido. Escriba exactamente: Terror, Accion o Aventura.")

    while True:
        edad_texto = input(Fore.BLUE + "Ingrese su edad: ")
        if edad_texto.strip() == "":
            print(Fore.RED + "ERROR... no puede estar vacio.")
            continue
        if not edad_texto.isdigit():
            print(Fore.RED + "ERROR... debe ser un numero.")
            continue
        edad = int(edad_texto)
        if edad < 5 or edad > 90:
            print(Fore.RED + "ERROR... la edad debe estar entre 5 y 90 anos.")
            continue
        break
    ...
    while True:
        try:
            ...
            if almacenamiento > 0:
                break
            print(Fore.RED + "El almacenamiento debe ser mayor a 0.")
        except:
    ...
    while True:
        try:
            ...
            if presupuesto > 0:
                break
            print(Fore.RED + "El presupuesto debe ser mayor a 0.")
        except:
            print(Fore.RED + "Solo se aceptan numeros enteros.")
    ...
    if plataforma == "PC":
        ...
        if genero == "Accion" and edad < 13:
            print(Fore.RED + "Lo sentimos " + nick + ", Accion es para mayores de 13.")
            genero = input(Fore.BLUE + "Escriba el nuevo Genero: ")
    ...
    repetir = input(Fore.BLUE + "¿Desea ingresar otro usuario? (S/N): ")
...
print(Fore.WHITE + "=" * 50)
print(Fore.CYAN + "ESTADISTICAS GENERALES")
print(Fore.WHITE + "=" * 50)

print(Fore.YELLOW + f"Terror: {cont_terror}")
print(Fore.YELLOW + f"Accion: {cont_accion}")
print(Fore.YELLOW + f"Aventura: {cont_aventura}")

if cont_terror > cont_accion and cont_terror > cont_aventura:
    print(Fore.GREEN + "El genero más elegido es: Terror")
elif cont_accion > cont_terror and cont_accion > cont_aventura:
    print(Fore.GREEN + "El genero más elegido es: Accion")
elif cont_aventura > cont_terror and cont_aventura > cont_accion:
    print(Fore.GREEN + "El genero más elegido es: Aventura")
else:
    print(Fore.GREEN + "Hay empate entre generos")

if cont_terror < cont_accion and cont_terror < cont_aventura:
    print(Fore.RED + "El genero menos elegido es: Terror")
elif cont_accion < cont_terror and cont_accion < cont_aventura:
    print(Fore.RED + "El genero menos elegido es: Accion")
elif cont_aventura < cont_terror and cont_aventura < cont_accion:
    print(Fore.RED + "El genero menos elegido es: Aventura")
else:
    print(Fore.RED + "Hay empate en el genero menos elegido")
